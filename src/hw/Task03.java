...
public class Task03 extends HW{
    Task03(int task_nr){
        /*
         * HW 3. * Карацуба
         */
        print_header(task_nr, null);
        BigInteger n1 = new BigInteger (200, new Random());
        BigInteger n2 = new BigInteger (200, new Random());
        
        // Karatsuba alg
        System.out.println( karatsuba_multiplication(n1, n2).toString() + " - Karatsuba alg");
        // Test 
        System.out.println( (n1.multiply(n2)).toString() + " - test result calculated with BigInteger multiply" );
    }

    private static BigInteger karatsuba_multiplication(BigInteger n1, BigInteger n2){
        /*

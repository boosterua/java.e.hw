...
/**
 * Created by tonchief on 12/15/2016.
 */
    ...
    class Conversion
    {
        ...
        public String inToPost()
        {
            for (int i = 0; i < input.length(); i++)
            {
                ...
                switch (ch)
                {
                    ...
                    case '*':
                    case '/':
                        gotOperator(ch, 2);                System.out.println("i:"+i);
                        break;
                    case '(':
                        s.push(ch);
                        break;
        ...
        {
            System.out.println(opThis + "got Operator");
            while (!s.isEmpty())
            {
                char opTop = s.pop();
                if (opTop == '(')
...
//System.out.println(newNode.toString());
                        ...
                        || symbol == '*')
                {
                    ...
                    stk.push(newNode);
//                    System.out.println("LRn:"+newNode.toString());
                }
                symbol = s.charAt(++i);
            }
            root = stk.pop();
